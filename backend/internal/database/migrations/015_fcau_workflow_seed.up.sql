...
(
    'fcau-v1',
    'FCAU Export Health Certificate Issuance',
    '1',
    '{
        ...
        "edges": [
            ...
            { "id": "e_apply_rejected", "source_id": "fcau_apply_split",       "target_id": "end_rejected",
              "condition": "fcau.application_review_outcome == ''reject''" },
            { "id": "e_apply_approved", "source_id": "fcau_apply_split",       "target_id": "fcau_2_pay_app_fee",
              "condition": "fcau.application_review_outcome == ''approve''" },

            { "id": "e_payment_gateway","source_id": "fcau_2_pay_app_fee",     "target_id": "fcau_payment_split" },
            { "id": "e_payment_fail",   "source_id": "fcau_payment_split",     "target_id": "end_payment_failed",
              "condition": "fcau.app_fee_payment_status == ''fail''" },
            { "id": "e_payment_pass",   "source_id": "fcau_payment_split",     "target_id": "fcau_2_1_sample_decision",
              "condition": "fcau.app_fee_payment_status == ''success''" },

            { "id": "e_sample_gateway", "source_id": "fcau_2_1_sample_decision","target_id": "fcau_sample_split" },
            { "id": "e_sample_no",      "source_id": "fcau_sample_split",      "target_id": "fcau_join_approval",
              "condition": "fcau.sample_required == false" },
            { "id": "e_sample_yes",     "source_id": "fcau_sample_split",      "target_id": "fcau_3_wait_sample",
              "condition": "fcau.sample_required == true" },
            ...
            { "id": "e_lab_no",         "source_id": "fcau_lab_split",         "target_id": "fcau_join_approval",
              "condition": "fcau.lab_test_required == false" },
            { "id": "e_lab_yes",        "source_id": "fcau_lab_split",         "target_id": "fcau_4_pay_lab_fee",
              "condition": "fcau.lab_test_required == true" },

            { "id": "e_lab_payment_gateway","source_id": "fcau_4_pay_lab_fee", "target_id": "fcau_lab_payment_split" },
            { "id": "e_lab_payment_fail","source_id": "fcau_lab_payment_split","target_id": "end_payment_failed",
              "condition": "fcau.lab_fee_payment_status == ''fail''" },
            { "id": "e_lab_payment_pass","source_id": "fcau_lab_payment_split","target_id": "fcau_5_lab_test",
              "condition": "fcau.lab_fee_payment_status == ''success''" },

            { "id": "e_lab_test_gateway","source_id": "fcau_5_lab_test",       "target_id": "fcau_lab_result_split" },
            { "id": "e_lab_result_fail","source_id": "fcau_lab_result_split",  "target_id": "end_lab_failed",
              "condition": "fcau.lab_test_result == ''fail''" },
            { "id": "e_lab_result_pass","source_id": "fcau_lab_result_split",  "target_id": "fcau_join_approval",
              "condition": "fcau.lab_test_result == ''pass''" },
