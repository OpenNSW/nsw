...
(
    ...
    '{
        ...
        "nodes": [
            ...
            { "id": "node_1:application_submission", "type": "TASK", "task_template_id": "fcau:application_submission", "output_mapping": { "application_id": "fcau:application_id" } },
            { "id": "node_2:wait_sample_drop", "type": "TASK", "task_template_id": "fcau:sample_drop", "input_mapping": { "fcau:application_id": "application_id" }, "output_mapping": { "sample_drop_confirmed": "fcau_sample_drop_confirmed" } },
            { "id": "node_3:wait_testing_requirement", "type": "TASK", "task_template_id": "fcau:testing_requirement", "input_mapping": { "fcau:application_id": "application_id" }, "output_mapping": { "lab_testing_status": "fcau_lab_testing_status", "required_tests": "fcau_required_tests" } },
            ...
            { "id": "node_5:lab_results_review", "type": "TASK", "task_template_id": "fcau:lab_results_review", "input_mapping": { "fcau:application_id": "application_id", "fcau_required_tests": "required_tests" }, "output_mapping": { "lab_decision": "fcau_lab_decision" } },
            ...
            { "id": "node_7:certificate_issue", "type": "TASK", "task_template_id": "fcau:certificate_issue", "input_mapping": { "fcau:application_id": "application_id" }, "output_mapping": { } },
        ...
        "edges": [
            ...
            { "id": "e_5:gateway_to_lab_payment", "source_id": "gw_1:requires_lab_test", "target_id": "node_4:lab_payment_upload", "condition": "fcau_lab_testing_status == ''Required''" },
            { "id": "e_6:gateway_to_join", "source_id": "gw_1:requires_lab_test", "target_id": "gw_3:proceed_to_payment", "condition": "fcau_requires_lab_test == ''Not Required''" },
